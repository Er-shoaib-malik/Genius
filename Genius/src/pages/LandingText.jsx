...
const TEXT = "Translate Documents[br]or Create E-Books[br]in Just a Few Clicks";
...
const FONT_SIZE_DESKTOP = 65;
const FONT_SIZE_TABLET = 36;
const FONT_SIZE_MOBILE = 26;

const BRAND_GENIUS_COLORS = false; // Disabled colored text
