...
export default function ContactForCompany() {
  ...
  const options = [
    ...
    },
    {
      ...
      title: "Not a Company?",
      desc: "← Contact us as an individual",
    },
  ];
      ...
      <div className="max-w-[1140px] w-full bg-black text-white flex flex-col md:flex-row justify-between gap-10 md:gap-0 poppins-light">
        ...
        <div className="w-full md:w-[45%] flex flex-col justify-start">
          ...
          >
            ...
            >
              How Can We Assist{" "}
              <span className="text-[#D5F37C]">Your Company </span>
              Today?
            </motion.h1>
            ...
            {options.map((item, index) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[#B3B3B3] font-medium text-[14px]">{item.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {["Company Email", "Company Name"].map((field) => (
                <div key={field}>
                  ...
                  <input
                    ...
                    placeholder={
                      field === "Company Email"
                        ? "buisness@yourcompany"
                        : "Company Name"
                    }
                    className="w-full h-[42px] bg-[#BBBBBB08] border border-[#EEEEEE1A] rounded-lg px-3 text-white text-[15px] font-regular placeholder:font-medium placeholder-[#999999] focus:outline-none focus:border-blue-500 transition"
                  />
                </div>
              ))}
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows="5"
                className="w-full bg-[#BBBBBB08] border border-[#EEEEEE1A] rounded-lg px-3 py-3 text-white text-[15px] font-regular placeholder:font-medium placeholder-[#999999] focus:outline-none focus:border-blue-500 transition resize-none"
              ></textarea>
            </div>
